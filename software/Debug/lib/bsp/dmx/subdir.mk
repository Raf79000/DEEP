...
lib/bsp/dmx/%.o lib/bsp/dmx/%.su lib/bsp/dmx/%.cyclo: ../lib/bsp/dmx/%.c lib/bsp/dmx/subdir.mk
...
clean: clean-lib-2f-bsp-2f-dmx

clean-lib-2f-bsp-2f-dmx:
	-$(RM) ./lib/bsp/dmx/dmx.cyclo ./lib/bsp/dmx/dmx.d ./lib/bsp/dmx/dmx.o ./lib/bsp/dmx/dmx.su

.PHONY: clean-lib-2f-bsp-2f-dmx
